...
$APPLICATION->SetAdditionalCSS(SITE_TEMPLATE_PATH . '/css/product-card-import.css', true);
$APPLICATION->AddHeadScript(SITE_TEMPLATE_PATH . '/js/jquery.pikachoose.js', true);
$APPLICATION->AddHeadScript(SITE_TEMPLATE_PATH . '/js/jquery.newPopup.js', true);
$APPLICATION->AddHeadScript(SITE_TEMPLATE_PATH . '/js/product-card-import.js', true);
?>
